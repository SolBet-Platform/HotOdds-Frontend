    ...
    <Layout>
      <div className='h-screen hidden md:flex flex-row bg-back p-6'>
        ...
        <div className='w-3/4 mt-0'>
          {/* Card 1 */}
          <div className='relative bg-cover bg-guy bg-center w-full max-w-md lg:max-w-2xl h-72 flex text-white rounded-md mt-4 overflow-hidden'>
        ...
        <div className='block h-52'>
          <div className='w-72 bg-guy rounded-md ml-6 h-40 mt-5 border-stone-500'>
            ...
            <div className='bg-guy w-full h-16 px-2 py-1 flex overflow-hidden'>
              ...
              <img
                src='/images/barca2.png'
                alt='Profile'
                className='w-16 h-16 rounded-full'
              />
            </div>
            <div className='mx-6 flex text-white text-sm'>
              <p className='pr-40'>Paris</p>
              <p>Barcelona</p>
            </div>
          ...
          <div className='w-72 bg-guy p-0 pb-5 rounded-md ml-6 h-52 mt-6 border-stone-500'>
            ...
            <div className='bg-back w-full h-10 px-2 py-1 flex items-center'>
              <img
                src='/images/paris3.png'
                alt='Profile'
                className='w-6 h-6 rounded-full mt-1'
              />
              <p className='text-white text-sm ml-2'>Paris</p>
              <p className='text-fuchsia-600 text-md mx-4'>vs</p>
              <img
                src='/images/barca3.png'
                alt='Profile'
                className='w-6 h-6 rounded-full mt-1'
              />
              <p className='text-white text-sm ml-2'>Barcelona</p>
            </div>
          ...
          <div className='text-white ml-8 mt-4'>
            <p className='text-lg font-bold pb-1'>Team Paris:</p>
            <p className='text-sm pb-1'>Formation: 4-3-3</p>
            <p className='text-sm'>Captain: James Davis</p>
          </div>
          <div className='text-white ml-8 mt-4'>
            <p className='text-lg font-bold pb-1'>Team Barcelona:</p>
          ...
          <div className='relative h-52'>
            ...
            <div className='w-full overflow-hidden flex'>
              <div className='text-white ml-8 mt-4 overflow-hidden'>
                <p className='text-base font-bold pb-1'>Team Paris:</p>
                <p className='text-xs pb-1'>Formation: 4-3-3</p>
                <p className='text-xs'>Captain: James Davis</p>
              </div>
              <div className='text-white ml-8 mt-4'>
                <p className='text-base font-bold pb-1'>Team Barcelona:</p>
